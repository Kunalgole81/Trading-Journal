import {
  m_draggable_default
} from "./chunk-CZJE4BUJ.js";
import {
  text_box_default,
  ui_search_box_mixin_default
} from "./chunk-2N3IDVRF.js";
import {
  fx_default,
  getBoundingRect,
  resetPosition
...
var animate = (element, config) => {
  ...
  element.style.transition = fx_default.off ? "" : "transform ".concat(config.duration, "ms ").concat(config.easing);
};
...
//# sourceMappingURL=chunk-AEAEB45N.js.map
